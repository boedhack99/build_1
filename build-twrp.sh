...
DEVICE_SOURCE=https://github.com/boedhack99/android_device_xiaomi_mojito.git
DT_DIR=device/$DEVICE_MANUFACTURER/$DEVICE_CODE
GIT_USER_NAME=boedhack99
GIT_USER_EMAIL=boedhack@gmail.com
GIT_COLOR_UI=false
###################################################################################
...
make -j# bootimage
curl --upload-file ./out/target/product/mojito/recovery.img https://transfer.sh/twrp-mojito-001.img